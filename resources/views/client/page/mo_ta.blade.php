    ...
    <div id="app">
        <div class="row">
            <div class="text-center alert alert-info" role="alert">
                <h3>Chi Tiết Chú Cưng</h3>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-4">
                        <img v-bind:src="sanpham.hinh_anh" alt="" style="height:300px; weigh: 400px ">
                    </div>
                    <div class="col-8">
                        <div style="height: 300px" class="card ">
                            <div class="card-header">
                                <h5>@{{sanpham.ten_thu}}</h5>
                            </div>
                            <div class="card-body">
                                @{{sanpham.mo_ta}}
                                <br>
                                Giá: <b>@{{format(sanpham.gia_ban)}}</b>
                            </div>
        ...
        new Vue({
            ...
            methods :   {
                ...
                loadData() {
                    ...
                    axios.post('{{Route("chiTietInfo")}}', payload)
                        .then((res) => {
