                        ...
                        <div class="card" >
                            <div class="card-body">
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <a v-bind:href="'/detail/' + v.id" type="button" class="btn btn-outline-secondary">Chi tiết sản phẩm</a>
                                  </div>
                                </p>
                            </div>
                ...
                <div class="col-3 text-nowrap">
                    <div class="card" >
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a  v-bind:href="'/lien-quan/detail/' + value.id" type="button" class="btn btn-outline-secondary">Chi tiết sản phẩm</a>
                              </div>
                            </p>
                        </div>
                        <div class="card-footer">
