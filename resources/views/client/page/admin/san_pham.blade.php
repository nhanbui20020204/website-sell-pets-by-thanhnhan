...
<div id="app">
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <button data-bs-toggle="modal" data-bs-target="#themThuModal" type="button" class="btn btn-primary">Thêm Mới sản phẩm</button>
                        ...
                        <div class="modal-body">
                            <div class="row mb-2">
                                <div class="col">
                                    ...
                                    <input v-model="them_moi.ten_san_pham" type="text" class="form-control" placeholder="Nhập vào tên sản phẩm">
                                </div>
                                <div class="col">
                                    <label class="mb-2">Slug sản phẩm</label>
                                    <input v-model="them_moi.slug_san_pham" type="text" class="form-control" placeholder="Nhập vào slug sản phẩm">
                                </div>
                                <div class="col">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-8">
                                    ...
                                    <input v-model="them_moi.mieu_ta" type="text" class="form-control" placeholder="Nhập vào thể loại">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-8">
                                                <label class="mb-2">Mô Tả</label>
                                    <input v-model="edit.mieu_ta" type="text" class="form-control" placeholder="Nhập vào thể loại">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
     ...
     $(document).ready(function() {
        new Vue({
            ...
            methods:        {
                themThu() {
                    axios
                        .post('{{ Route("sanPhamStore") }}', this.them_moi)
                        .then((res) => {
                            if(res.data.status) {
                ...
                xoaSlide() {
                    axios
                        .post('{{ Route("sanPhamDel") }}', this.tt_xoa)
                        .then((res) => {
                            if(res.data.status) {
                                toastr.success(res.data.message, 'Success');
                                this.loadData();
