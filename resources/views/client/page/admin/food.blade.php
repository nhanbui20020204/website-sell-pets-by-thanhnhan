     ...
     $(document).ready(function() {
        new Vue({
            ...
            methods:        {
                themsanPham() {
                    axios
                        .post('{{ Route("thucAnStore") }}', this.them_moi)
                        .then((res) => {
                            if(res.data.status) {
                ...
                xoaSlide() {
                    axios
                        .post('{{ Route("thucAnDel") }}', this.tt_xoa)
                        .then((res) => {
                            if(res.data.status) {
                                toastr.success(res.data.message, 'Success');
                                this.loadData();
                ...
                capNhatSanPham() {
                    axios
                        .post('{{ Route("thucAnUpdate") }}', this.edit)
                        .then((res) => {
                            if(res.data.status) {
                                toastr.success(res.data.message, 'Success');
                                this.loadData();
                ...
                doiTrangThai(payload) {
                    axios
                        .post('{{ Route("thucAnStatus") }}', payload)
                        .then((res) => {
                            if(res.data.status) {
                                toastr.success(res.data.message, 'Success');
                                this.loadData();
