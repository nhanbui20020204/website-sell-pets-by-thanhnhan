                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-6">
                                    ...
                                    <input v-model="them_moi.mo_ta" type="text" class="form-control" placeholder="Nhập vào thể loại">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-6">
                                                <label class="mb-2">Mô Tả</label>
                                    <input v-model="edit.mo_ta" type="text" class="form-control" placeholder="Nhập vào thể loại">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
     ...
     $(document).ready(function() {
        new Vue({
            ...
            methods:        {
                themThu() {
                    axios
                        .post('{{ Route("trangChuStore") }}', this.them_moi)
                        .then((res) => {
                            if(res.data.status) {
                ...
                xoaSlide() {
                    axios
                        .post('{{ Route("trangChuDel") }}', this.tt_xoa)
                        .then((res) => {
                            if(res.data.status) {
                                toastr.success(res.data.message, 'Success');
                                this.loadData();
                ...
                capNhatThu() {
                    axios
                        .post('{{ Route("trangChuUpdate") }}', this.edit)
                        .then((res) => {
                            if(res.data.status) {
                                toastr.success(res.data.message, 'Success');
                                this.loadData();
                ...
                doiTrangThai(payload) {
                    axios
                        .post('{{ Route("trangChuStatus") }}', payload)
                        .then((res) => {
                            if(res.data.status) {
                                toastr.success(res.data.message, 'Success');
                                this.loadData();
